...
def get_lettre():
    return feuille.textinput(title="Proposer une lettre",prompt="Quelle lettre proposez-vous ?")
...
def resultat(mot, trouve):
    crayon.penup()
    crayon.goto(0,300)
    crayon.pendown()
    if trouve:
        crayon.write("BRAVO ! Vous avez gagné.", font=("Arial",24,"bold"),align="center")
    else:
        crayon.write("PERDU... le mot était "+mot, font=("Arial",24,"bold"),align="center")
